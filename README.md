# SEO Code Refactor
The purpose of this weekly challenge is to refactor Horiseon's website code to be up to date with current website standards focusing on accessibility; including primarily html semantics and img alt atributes. As part of this task I should also endeavor to improve the code base I am working within, leaving it cleaner and ready for future developers.
